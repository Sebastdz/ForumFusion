...
if (isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in']) {
    echo "<button class='deletebutton' onclick='deletePost(" . $data['post_id'] . ")'><i class='fa-solid fa-trash'></i></button>";
    echo "<button class='deletebutton' onclick='deletePostByStaff(" . $data['post_id'] . ")'><i class='fa-solid fa-delete-left'></i></button>";
    echo "<button class='deletebutton' onclick='banUser(\"" . $data['post_id'] . "\")'><i class='fa-solid fa-user-slash'></i></button>";
} 
...
// Check if the user is a premium user and is the owner of the post
    ...
    echo "<button class='deletebutton' onclick='deletePostByUser(" . $data['post_id'] . ")'><i class='fa-solid fa-trash'></i></button>";
} 
